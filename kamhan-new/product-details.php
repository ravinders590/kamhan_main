<?php include('inc/dbconnection.php'); 
   ...
   if((!empty($productId)) AND (!empty($subcatId)))
   {			
   
      $sql = "SELECT * FROM products WHERE (sub_category = $subcatId)";
   }
   else
   {	
      $sql = "SELECT * FROM products WHERE (id = $productId OR category = $productId)";
   }
...
<html lang="en-US">
   <head>
      ...
      <meta property="og:description" content="<?php echo $meta_dec; ?>" />
