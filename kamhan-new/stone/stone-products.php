...
<html lang="en-US">
	<head>
		...
		<title>Kamhan Industrial | Stone | publishing & Cutting</title>
                                         ...
                                         <div id="ct_heading-3454c25" class="ct-heading h-align-center item-st-default">
                                          <div class="heading-wrapper">
                                           <div class="inner-heading">
                                            <h4 class="item--title case-animate-time st-default" data-wow-delay="ms"><span>KAMHAN INDUSTRIAL LIMITED</span></h4>
                                           </div>
                                          </div>
                                         </div>
                                        </div>
                                        ...
                                        <article id="post-13823" class="post-13823 page type-page status-publish hentry">
                                         <div class="entry-content clearfix">
                                          <div data-elementor-type="wp-page" data-elementor-id="13823" class="elementor elementor-13823">
										   ...
										   Since 1975 KAMHAN INDUSTRIAL LTD. is actively involved in the purchase and sale of used machines on a worldwide basis. Stone Machinery business we had started 3 years back only in 2012. We are active Agent for Hesheng Brand Machines, "Hesheng is the Biggest and Best Granite Machine Maker". We pay particular attention to individual and professional advice.
Just check our current offers in order to see if we have the right machine for you. If not, just contact us or send us your enquiry through mail and let us know what you are looking for. With our competence we can offer you an ideal price and ideal deal.
