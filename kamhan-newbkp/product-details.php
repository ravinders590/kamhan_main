                                                       ...
                                                       <div class="col-lg-4 col-md-5">
                                                           <div class="woocommerce-product-gallery woocommerce-product-gallery--with-images woocommerce-product-gallery--columns-4 images" data-columns="4" style="opacity: 0; transition: opacity 0.25s ease-in-out;">
                                                               <div class="woocommerce-product-gallery__wrapper">
                                                                   ...
                                                                   <div data-thumb="admin/upload/<?php echo $row['product_photo']; ?>" data-thumb-alt="" class="woocommerce-product-gallery__image">
                                                                       <a href="admin/upload/<?php echo $row['product_photo']; ?>">
                                                                           <img
                                                                               width="280"
                                                                               height="280"
                                                                               src="admin/upload/<?php echo $row['product_photo']; ?>"
                                                                               class=""
                                                                               alt=""
                                                                               decoding="async"
                                                                               loading="lazy"
                                                                               title="pic-4"
                                                                               data-caption=""
                                                                               data-src="admin/upload/<?php echo $row['product_photo']; ?>"
                                                                               data-large_image="admin/upload/<?php echo $row['product_photo']; ?>"
                                                                               data-large_image_width="280"
                                                                               data-large_image_height="280"
                                                                               srcset="admin/upload/<?php echo $row['product_photo']; ?>"
                                                                               sizes="(max-width: 280px) 100vw, 280px"
                                                                           />
                                                                       </a>
                                                                   </div>
               
                                                                   <div data-thumb="admin/upload/<?php echo $row['product_photo_th_01']; ?>" data-thumb-alt="" class="woocommerce-product-gallery__image">
                                                                       <a href="admin/upload/<?php echo $row['product_photo_th_01']; ?>">
                                                                           <img
                                                                               width="280"
                                                                               height="280"
                                                                               src="admin/upload/<?php echo $row['product_photo_th_01']; ?>"
                                                                               class=""
                                                                               alt=""
                                                                               decoding="async"
                                                                               loading="lazy"
                                                                               title="pic-4"
                                                                               data-caption=""
                                                                               data-src="admin/upload/<?php echo $row['product_photo_th_01']; ?>"
                                                                               data-large_image="admin/upload/<?php echo $row['product_photo_th_01']; ?>"
                                                                               data-large_image_width="280"
                                                                               data-large_image_height="280"
                                                                               srcset="admin/upload/<?php echo $row['product_photo_th_01']; ?>"
                                                                               sizes="(max-width: 280px) 100vw, 280px"
                                                                           />
                                                                       </a>
                                                                   </div>
               
                                                                   <div data-thumb="admin/upload/<?php echo $row['product_photo_th_02']; ?>" data-thumb-alt="" class="woocommerce-product-gallery__image">
                                                                       <a href="admin/upload/<?php echo $row['product_photo_th_02']; ?>">
                                                                           <img
                                                                               width="280"
                                                                               height="280"
                                                                               src="admin/upload/<?php echo $row['product_photo_th_02']; ?>"
                                                                               class=""
                                                                               alt=""
                                                                               decoding="async"
                                                                               loading="lazy"
                                                                               title="pic-4"
                                                                               data-caption=""
                                                                               data-src="admin/upload/<?php echo $row['product_photo_th_02']; ?>"
                                                                               data-large_image="admin/upload/<?php echo $row['product_photo_th_02']; ?>"
                                                                               data-large_image_width="280"
                                                                               data-large_image_height="280"
                                                                               srcset="admin/upload/<?php echo $row['product_photo_th_02']; ?>"
                                                                               sizes="(max-width: 280px) 100vw, 280px"
                                                                           />
                                                                       </a>
                                                                   </div>
               
                                                                   <div data-thumb="admin/upload/<?php echo $row['product_photo_th_03']; ?>" data-thumb-alt="" class="woocommerce-product-gallery__image">
                                                                       <a href="admin/upload/<?php echo $row['product_photo_th_03']; ?>">
                                                                           <img
                                                                               width="280"
                                                                               height="280"
                                                                               src="admin/upload/<?php echo $row['product_photo_th_03']; ?>"
                                                                               class=""
                                                                               alt=""
                                                                               decoding="async"
                                                                               loading="lazy"
                                                                               title="pic-4"
                                                                               data-caption=""
                                                                               data-src="admin/upload/<?php echo $row['product_photo_th_03']; ?>"
                                                                               data-large_image="admin/upload/<?php echo $row['product_photo_th_03']; ?>"
                                                                               data-large_image_width="280"
                                                                               data-large_image_height="280"
                                                                               srcset="admin/upload/<?php echo $row['product_photo_th_03']; ?>"
                                                                               sizes="(max-width: 280px) 100vw, 280px"
                                                                           />
                                                                       </a>
                                                                   </div>
																   <?php if ($row['product_photo_th_04']!=''){ ?>
																   <div data-thumb="admin/upload/<?php echo $row['product_photo_th_04']; ?>" data-thumb-alt="" class="woocommerce-product-gallery__image">
                                                                       <a href="admin/upload/<?php echo $row['product_photo_th_04']; ?>">
                                                                           <img
                                                                               width="280"
                                                                               height="280"
                                                                               src="admin/upload/<?php echo $row['product_photo_th_04']; ?>"
                                                                               class=""
                                                                               alt=""
                                                                               decoding="async"
                                                                               loading="lazy"
                                                                               title="pic-4"
                                                                               data-caption=""
                                                                               data-src="admin/upload/<?php echo $row['product_photo_th_04']; ?>"
                                                                               data-large_image="admin/upload/<?php echo $row['product_photo_th_03']; ?>"
                                                                               data-large_image_width="280"
                                                                               data-large_image_height="280"
                                                                               srcset="admin/upload/<?php echo $row['product_photo_th_04']; ?>"
                                                                               sizes="(max-width: 280px) 100vw, 280px"
                                                                           />
                                                                       </a>
                                                                   </div>
