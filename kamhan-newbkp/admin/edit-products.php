          ...
          <div class="card-body">
            <form action="" method="post"  enctype="multipart/form-data">
              ...
              <div class="form-group">
                ...
                <input type="text" id="keywords" placeholder="SEO Keywords" class="form-control" name="keywords" required="" value="<?php echo $product_data['keywords'];?> ">
              </div>
              <div class="form-group">
                <fieldset class="fieldset">
                  ...
                  <div class="form-group">
                    <select name="sub_category" id="sub_category_data" class="form-control" required="">
			  ...
			  <div class="form-group">
                <fieldset class="fieldset">
                  ...
                  <div class="form-group">
                    <div class="custom-control custom-radio d-inline mr-2">
                      <input class="custom-control-input" type="radio" id="customRadio1" name="maincategory" checked="" value="1">
                      <label for="customRadio1" class="custom-control-label">Footwear</label>
                    </div>
					<div class="custom-control custom-radio d-inline mr-2">
                      <input class="custom-control-input" type="radio" id="customRadio1" name="maincategory" checked="" value="2">
                      <label for="customRadio1" class="custom-control-label">Stone</label>
                    </div>
                    <div class="custom-control custom-radio d-inline">
                      <input class="custom-control-input" type="radio" id="customRadio2" name="maincategory" value="3">
