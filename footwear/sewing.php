...
<div class="contentDiv" style="padding-top:20px;"></div>
	<div id="AllproductDivs" style="height:500px; overflow:auto; margin-top:10px;">
        ...
        <div class="productDiv">
        	<a href="sewingdesc.php"><img src="images/products/sewing/1.jpg" /></a>
            <a href="sewingdesc.php"><h2>Sewing Machine for Moccasins</h2></a>
            
            <br />
            <a href="sewingdesc.php" class="productDivdetails">Details</a>
        </div>
