    ...
    <div id="slider1_container" style="position: relative; width: 600px;
        ...
        <div u="slides" style="cursor: move; position: absolute; left: 0px; top: 0px; width: 600px; height: 300px;
			...
			<div>
                <a u=image href="#"><img src="images/slides/slide4.jpg" /></a>
                <div u=caption t="*" class="captionOrange"  style="position:absolute; left:20px; top: 30px; width:330px; height:30px;"> 
                Footwear Machinery
                </div>
            </div>
			
				<div>
                <a u=image href="#"><img src="images/slides/slide5.jpg" /></a>
                <div u=caption t="*" class="captionOrange" style="position:absolute; left:20px; top: 30px; width:330px; height:30px;"> 
                PVC Air Blowing Machine
                </div>
            </div>
			<div>
                <a u=image href="#"><img src="images/slides/slide3.jpg" /></a>
                <div u=caption t="*" class="captionOrange"  style="position:absolute; left:52px; top: 20px; width:330px; height:30px;"> 
                Pu Rotary Injection Machine 
                </div>
            </div>
            <div>
                <a u=image href="#"><img src="images/slides/slide9.jpg" /></a>
                <div u=caption t="*" class="captionOrange"  style="position:absolute; left:52px; top: 20px; width:330px; height:30px;"> 
                Kam Han Industrial Ltd Moulds 
                </div>
            </div>
			<div>
                <a u=image href="#"><img src="images/slides/slide2.jpg" /></a>
                <div u=caption t="*" class="captionOrange"  style="position:absolute; left:20px; top: 30px; width:430px; height:30px;"> 
                Kam Han Industrial Ltd. believe's that Your Success is Our Success.
                </div>
            </div>
			<div>
                <a u=image href="#"><img src="images/slides/slide1.jpg" /></a>
                <div u=caption t="*" class="captionOrange" style="position:absolute; left:20px; top: 30px; width:330px; height:30px;"> 
                Footwear Machinery
                </div>
            </div>
            <div>
                <a u=image href="#"><img src="images/slides/slide6.jpg" /></a>
                <div u=caption t="*" class="captionOrange"  style="position:absolute; left:20px; font-size:12px !Important; top: 30px; width:300px; height:30px;"> 
                Kam Han Industrial Ltd. - Yes: "Kam Han is Excellence".
                </div>
            </div>
            <div>
                <a u=image href="#"><img src="images/slides/slide7.jpg" /></a>
                <div u=caption t="*" class="captionOrange"  style="position:absolute; left:20px; top: 30px; width:300px; height:30px;"> 
                Granite/Stone Cutting Machinery
                </div>
            </div>
            <!--div>
                <a u=image href="#"><img src="images/slides/slidec.jpg" /></a>
                <div u=caption t="*" class="captionOrange"  style="position:absolute; left:20px; top: 30px; width:300px; height:30px;"> 
                Foaming Press Machine
                </div>
            </div-->
            <div>
                <a u=image href="#"><img src="images/slides/slide8.jpg" /></a>
                <div u=caption t="*" class="captionOrange"  style="position:absolute; left:20px; top: 30px; width:430px; height:30px;"> 
                Kam Han Industrial Ltd. believe's that Your Success is Our Success.
                </div>
            </div>
